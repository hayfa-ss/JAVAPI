...
public class AfficherPersonnesController2 {
...
// modifinfo
    ...
    void initialize() {
        try {
            List<Payment> personneList = sp.afficherbyid(1);
            ...
            tableView.getSelectionModel().selectedItemProperty().addListener(new ChangeListener<Payment>() {
                ...
                public void changed(ObservableValue<? extends Payment> observable, Payment oldValue, Payment newValue) {
                    if (newValue != null) {
                        ...
                        // Print any other information you want...
                    }
                }
            });
    ...
    void delete(ActionEvent event) {
        try {
            ...
            if (selectedPayment != null) {
                ...
                System.err.println("Aucune personne sélectionnée.");
            }
        } catch (SQLException e) {
            System.err.println(e.getMessage());
        }
